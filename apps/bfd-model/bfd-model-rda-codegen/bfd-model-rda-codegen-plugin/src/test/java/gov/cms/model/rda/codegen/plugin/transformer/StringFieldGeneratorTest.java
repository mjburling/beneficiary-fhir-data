...
public class StringFieldGeneratorTest {
  ...
  public void requiredField() {
    ColumnBean column =
        ColumnBean.builder().name("hicNo").nullable(false).sqlType("varchar(12)").build();
    ...
    assertEquals(
        "transformer.copyString(gov.cms.bfd.model.rda.PreAdjFissClaim.Fields.hicNo, false, 1, 12, from.getHicNo(), to::setHicNo);\n",
        block.toString());
  }
