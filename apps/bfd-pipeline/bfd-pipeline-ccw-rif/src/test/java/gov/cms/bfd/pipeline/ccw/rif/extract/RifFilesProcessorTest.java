...
public final class RifFilesProcessorTest {
  ...
  public void process1BeneRecord() {
    ...
    Assert.assertEquals(
        String.valueOf(beneRow.getBeneficiaryId()), rifRecordEvent.getBeneficiaryId());
    Assert.assertEquals(RecordAction.INSERT, rifRecordEvent.getRecordAction());
    Assert.assertEquals(567834L, beneRow.getBeneficiaryId());
    ...
    Assert.assertEquals(Character.valueOf('1'), beneRow.getRace().get());
    Assert.assertEquals(Character.valueOf('1'), beneRow.getEntitlementCodeOriginal().get());
    Assert.assertEquals(Character.valueOf('1'), beneRow.getEntitlementCodeCurrent().get());
    Assert.assertEquals(Character.valueOf('N'), beneRow.getEndStageRenalDiseaseCode().get());
    Assert.assertEquals(new String("20"), beneRow.getMedicareEnrollmentStatusCode().get());
    Assert.assertEquals(Character.valueOf('0'), beneRow.getPartBTerminationCode().get());
    Assert.assertEquals(Character.valueOf('0'), beneRow.getPartBTerminationCode().get());
    ...
    Assert.assertEquals(Character.valueOf('A'), beneRow.getNameMiddleInitial().get());
    ...
    Assert.assertEquals(Character.valueOf('1'), beneRow.getHmoIndicatorAprInd().get());
    Assert.assertEquals(Short.valueOf((short) 5), beneRow.getPartDMonthsCount().get());
    Assert.assertEquals("00", beneRow.getPartDLowIncomeCostShareGroupFebCode().get());
    Assert.assertEquals(Character.valueOf('N'), beneRow.getPartDRetireeDrugSubsidyDecInd().get());
    ...
    Assert.assertEquals(Long.valueOf(1L), beneRow.getBeneLinkKey().get());
  }
  ...
  public void processBeneficiaryHistoryRecord_SAMPLE_A() {
    ...
    Assert.assertEquals(
        String.valueOf(beneficiaryHistory0.getBeneficiaryId()), rifRecordEvent0.getBeneficiaryId());
    Assert.assertEquals(RecordAction.INSERT, rifRecordEvent0.getRecordAction());
    Assert.assertEquals(567834L, beneficiaryHistory0.getBeneficiaryId());
    ...
    for (RifRecordEvent<?> rifRecordEvent :
      ...
      Assert.assertEquals(RecordAction.INSERT, rifRecordEvent.getRecordAction());
      Assert.assertEquals(567834L, beneficiaryHistory.getBeneficiaryId());
  ...
  public void process1MedicareBeneficiaryIdHistoryRecord() {
    ...
    Assert.assertEquals(567834L, medicareBeneficiaryIdHistory.getBeneficiaryId());
    Assert.assertEquals(
  ...
  public void process1PDERecord() {
    ...
    Assert.assertEquals(RecordAction.INSERT, rifRecordEvent.getRecordAction());
    Assert.assertEquals(
        String.valueOf(pdeRow.getBeneficiaryId()), rifRecordEvent.getBeneficiaryId());
    Assert.assertEquals(89L, pdeRow.getClaimId());
    Assert.assertEquals(900L, pdeRow.getClaimGroupId());
    Assert.assertEquals(567834L, pdeRow.getBeneficiaryId());
    ...
    Assert.assertEquals(799999L, pdeRow.getPrescriptionReferenceNumber());
    ...
    Assert.assertEquals(Character.valueOf('P'), pdeRow.getDispensingStatusCode().get());
    Assert.assertEquals('C', pdeRow.getDrugCoverageStatusCode());
    Assert.assertEquals(Character.valueOf('A'), pdeRow.getAdjustmentDeletionCode().get());
    Assert.assertEquals(Character.valueOf('X'), pdeRow.getNonstandardFormatCode().get());
    Assert.assertEquals(Character.valueOf('M'), pdeRow.getPricingExceptionCode().get());
    Assert.assertEquals(Character.valueOf('C'), pdeRow.getCatastrophicCoverageCode().get());
    ...
    Assert.assertEquals(Character.valueOf('3'), pdeRow.getPrescriptionOriginationCode().get());
    Assert.assertEquals(new BigDecimal("317.22"), pdeRow.getGapDiscountAmount());
    Assert.assertEquals(Character.valueOf('G'), pdeRow.getBrandGenericCode().get());
  ...
  public void process1CarrierClaimRecord() {
    ...
    Assert.assertEquals(RecordAction.INSERT, rifRecordEvent.getRecordAction());
    Assert.assertEquals(
        String.valueOf(claimGroup.getBeneficiaryId()), rifRecordEvent.getBeneficiaryId());
    Assert.assertEquals(567834L, claimGroup.getBeneficiaryId());
    Assert.assertEquals(9991831999L, claimGroup.getClaimId());
    Assert.assertEquals(900L, claimGroup.getClaimGroupId());
    ...
    Assert.assertEquals(Character.valueOf('A'), claimGroup.getProviderAssignmentIndicator().get());
    ...
    Assert.assertEquals(Character.valueOf('5'), claimGroup.getHcpcsYearCode().get());
    ...
    Assert.assertEquals(
        Character.valueOf('0'), claimGroup.getDiagnosisPrincipalCodeVersion().get());
    Assert.assertEquals("H5555", claimGroup.getDiagnosis1Code().get());
    Assert.assertEquals(Character.valueOf('0'), claimGroup.getDiagnosis1CodeVersion().get());
    Assert.assertEquals("H8888", claimGroup.getDiagnosis2Code().get());
    Assert.assertEquals(Character.valueOf('0'), claimGroup.getDiagnosis2CodeVersion().get());
    Assert.assertEquals("H66666", claimGroup.getDiagnosis3Code().get());
    Assert.assertEquals(Character.valueOf('0'), claimGroup.getDiagnosis3CodeVersion().get());
    Assert.assertEquals("H77777", claimGroup.getDiagnosis4Code().get());
    Assert.assertEquals(Character.valueOf('0'), claimGroup.getDiagnosis4CodeVersion().get());
    ...
    Assert.assertEquals(6, claimLine.getLineNumber());
    ...
    Assert.assertEquals(Character.valueOf('1'), claimLine.getProviderParticipatingIndCode().get());
    Assert.assertEquals('0', claimLine.getReducedPaymentPhysicianAsstCode());
    Assert.assertEquals(1, claimLine.getServiceCount());
    ...
    Assert.assertEquals(Character.valueOf('0'), claimLine.getPaymentCode().get());
    Assert.assertEquals(Character.valueOf('0'), claimLine.getServiceDeductibleCode().get());
    Assert.assertEquals(1, claimLine.getMtusCount());
    Assert.assertEquals(Character.valueOf('3'), claimLine.getMtusCode().get());
    Assert.assertEquals("H12345", claimLine.getDiagnosisCode().get());
    Assert.assertEquals(Character.valueOf('0'), claimLine.getDiagnosisCodeVersion().get());
    ...
    Assert.assertEquals(0, claimLine.getAnesthesiaUnitCount());
  }
  ...
  public void process1InpatientClaimRecord() {
    ...
    Assert.assertEquals(
        String.valueOf(claimGroup.getBeneficiaryId()), rifRecordEvent.getBeneficiaryId());
    Assert.assertEquals(567834L, claimGroup.getBeneficiaryId());
    Assert.assertEquals(333333222222L, claimGroup.getClaimId());
    Assert.assertEquals(900L, claimGroup.getClaimGroupId());
    ...
    Assert.assertEquals(Character.valueOf('4'), claimGroup.getSourceAdmissionCd().get());
    ...
    Assert.assertEquals(12, claimGroup.getUtilizationDayCount());
    Assert.assertEquals(0, claimGroup.getCoinsuranceDayCount());
    Assert.assertEquals(0, claimGroup.getNonUtilizationDayCount());
    Assert.assertEquals(19, claimGroup.getBloodPintsFurnishedQty());
  ...
  public void process1OutpatientClaimRecord() {
    ...
    Assert.assertEquals(
        String.valueOf(claimGroup.getBeneficiaryId()), rifRecordEvent.getBeneficiaryId());
    Assert.assertEquals(567834L, claimGroup.getBeneficiaryId());
    Assert.assertEquals(1234567890L, claimGroup.getClaimId());
    Assert.assertEquals(900L, claimGroup.getClaimGroupId());
    ...
    Assert.assertEquals(25, claimLine.getLineNumber());
  ...
  public void process1SNFClaimRecord() {
    ...
    Assert.assertEquals(
        String.valueOf(claimGroup.getBeneficiaryId()), rifRecordEvent.getBeneficiaryId());
    Assert.assertEquals(567834L, claimGroup.getBeneficiaryId());
    Assert.assertEquals(777777777L, claimGroup.getClaimId());
    Assert.assertEquals(900L, claimGroup.getClaimGroupId());
    Assert.assertEquals('V', claimGroup.getNearLineRecordIdCode());
    ...
    Assert.assertEquals(17, claimGroup.getUtilizationDayCount());
    Assert.assertEquals(17, claimGroup.getCoinsuranceDayCount());
    Assert.assertEquals(0, claimGroup.getNonUtilizationDayCount());
    Assert.assertEquals(19, claimGroup.getBloodPintsFurnishedQty());
  ...
  public void process1HospiceClaimRecord() {
    ...
    Assert.assertEquals(
        String.valueOf(claimGroup.getBeneficiaryId()), rifRecordEvent.getBeneficiaryId());
    Assert.assertEquals(567834L, claimGroup.getBeneficiaryId());
    Assert.assertEquals(9992223422L, claimGroup.getClaimId());
    Assert.assertEquals(900L, claimGroup.getClaimGroupId());
    Assert.assertEquals('V', claimGroup.getNearLineRecordIdCode());
    ...
    Assert.assertEquals(Character.valueOf('C'), claimGroup.getPatientStatusCd().get());
    Assert.assertEquals(30, claimGroup.getUtilizationDayCount());
    ...
    Assert.assertEquals(1, claimLine.getLineNumber());
  ...
  public void process1HHAClaimRecord() {
    ...
    Assert.assertEquals(
        String.valueOf(claimGroup.getBeneficiaryId()), rifRecordEvent.getBeneficiaryId());
    Assert.assertEquals(567834L, claimGroup.getBeneficiaryId());
    Assert.assertEquals(2925555555L, claimGroup.getClaimId());
    Assert.assertEquals(900L, claimGroup.getClaimGroupId());
    Assert.assertEquals('W', claimGroup.getNearLineRecordIdCode());
    ...
    Assert.assertEquals(3, claimGroup.getTotalVisitCount());
  ...
  public void process1DMEClaimRecord() {
    ...
    Assert.assertEquals(
        String.valueOf(claimGroup.getBeneficiaryId()), rifRecordEvent.getBeneficiaryId());
    Assert.assertEquals(567834L, claimGroup.getBeneficiaryId());
    Assert.assertEquals(2188888888L, claimGroup.getClaimId());
    Assert.assertEquals(900L, claimGroup.getClaimGroupId());
    ...
    Assert.assertEquals(60, claimLine.getServiceCount());
    ...
    Assert.assertEquals(Character.valueOf('3'), claimLine.getSupplierTypeCode().get());
    Assert.assertEquals(new BigDecimal("0.00"), claimLine.getScreenSavingsAmount().get());
    Assert.assertEquals(60, claimLine.getMtusCount());
